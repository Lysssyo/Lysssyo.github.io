...
>
> ![image-20220901114951631](MyBatis.assets/image-20220901114951631.png) 
>
...
>
> ![image-20240523203530179](MyBatis.assets/image-20240523203530179.png)
>
> 
>
> 如果想要resources中的SQL映射文件与mapper在同一目录下，只需要在resources中建与接口同样层次的包就可以了：
>
> <img src="MyBatis.assets/image-20240813154856414.png" alt="image-20240813154856414" style="zoom:80%;" /><img src="MyBatis.assets/image-20240523203809099.png" alt="image-20240523203809099" style="zoom:50%;" />
...
> 配置Druid数据源：
>
> ![image-20240813020509528](MyBatis.assets/image-20240813020509528.png)
>
> 不配：
>
> ![image-20240813020529044](MyBatis.assets/image-20240813020529044.png)
...
![image-20240813134643668](MyBatis.assets/image-20240813134643668.png)
...
<img src="MyBatis.assets/image-20240813153341890.png" alt="image-20240813153341890" style="zoom:80%;" />
...
![image-20240813153535262](MyBatis.assets/image-20240813153535262.png)
...
<img src="MyBatis.assets/image-20240813153926193.png" alt="image-20240813153926193" style="zoom:80%;" />
...
> ```
>
> <img src="MyBatis.assets/image-20240813211817586.png" alt="image-20240813211817586" style="zoom:80%;" />
>
...
<img src="MyBatis.assets/image-20240813154310267.png" alt="image-20240813154310267" style="zoom:80%;" />



### 4.3 预编译SQL

从上面的例子可以看出，参数317578并没有在后面拼接，id的值是使用`?`进行占位。那这种SQL语句我们称为预编译SQL。![image-20240813155223666](MyBatis.assets/image-20240813155223666.png)
...
![image-20221210202222206](MyBatis.assets/image-20221210202222206.png)
...
<img src="MyBatis.assets/image-20240813160404599.png" alt="image-20240813160404599" style="zoom:60%;" />

而实体类的参数：

<img src="MyBatis.assets/image-20240813160435984.png" alt="image-20240813160435984" style="zoom: 60%;" />

表字段与实体参数不一致，执行查询时，结果无法正常返回

<img src="MyBatis.assets/image-20240813160535896.png" alt="image-20240813160535896" style="zoom:80%;" />

需要开启驼峰映射：

<img src="MyBatis.assets/image-20240813160631503.png" alt="image-20240813160631503" style="zoom:80%;" />
...
![image-20240813175939143](MyBatis.assets/image-20240813175939143.png)
...
<img src="MyBatis.assets/image-20240813180447448.png" alt="image-20240813180447448" style="zoom:70%;" />

> 注意同包。注意namespace，id以及resultType的书写

3. 测试

<img src="MyBatis.assets/image-20240813180543404.png" alt="image-20240813180543404" style="zoom:70%;" />

> 可以使用MyBatisX插件快速定位Mapper接口以及xml映射文件
>
> <img src="MyBatis.assets/image-20221213121521406.png" alt="image-20221213121521406" style="zoom: 67%;" />
>
> MybatisX的安装：
>
> <img src="MyBatis.assets/image-20221213120923252.png" alt="image-20221213120923252" style="zoom: 67%;" />
...
<img src="MyBatis.assets/image-20240813181753385.png" alt="image-20240813181753385" style="zoom:67%;" />
...
<img src="MyBatis.assets/image-20240813201919485.png" alt="image-20240813201919485" style="zoom:80%;" />
...
<img src="MyBatis.assets/image-20240813202127075.png" alt="image-20240813202127075" style="zoom:80%;" />
...
<img src="MyBatis.assets/image-20240813203513826.png" alt="image-20240813203513826" style="zoom:80%;" />

> 只有两个条件拼接两个条件

<img src="MyBatis.assets/image-20240813203602469.png" alt="image-20240813203602469" style="zoom:80%;" />
...
<img src="MyBatis.assets/image-20240813203750727.png" alt="image-20240813203750727" style="zoom: 80%;" />
...
<img src="MyBatis.assets/image-20240813205316058.png" alt="image-20240813205316058" style="zoom:80%;" />
...
<img src="MyBatis.assets/image-20240813205152178.png" alt="image-20240813205152178" style="zoom:80%;" />
...
<img src="MyBatis.assets/image-20240813212016437.png" alt="image-20240813212016437" style="zoom:80%;" />
...
<img src="MyBatis.assets/image-20240813214719312.png" alt="image-20240813214719312" style="zoom:80%;" />
...
<img src="MyBatis.assets/image-20220901182204358.png" style="zoom: 67%;" />

<img src="MyBatis.assets/image-20220901182249421.png" style="zoom:67%;" />
...
![image-20221213171244796](MyBatis.assets/image-20221213171244796.png)
