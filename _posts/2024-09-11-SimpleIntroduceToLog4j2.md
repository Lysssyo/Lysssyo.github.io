...
![image-20241101100352914](assets/2024-09-11-SimpleIntroduceToLog4j2.assets/image-20241101100352914.png)

但是更新到2.10版本以后，控制台中就无法显示彩色日志了，各种级别的日志混杂在一起，难以阅读

通过查阅[官方文档](https://logging.apache.org/log4j/2.x/manual/layouts.html#enable-jansi)，发现在2.10版本以后，Log4j2默认关闭了Jansi（一个支持输出ANSI颜色的类库）
